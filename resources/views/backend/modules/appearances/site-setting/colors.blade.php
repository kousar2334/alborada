...
@section('settings-content')
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.appearance.site.setting.colors.update') }}">
                @csrf
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ __tr('Primary Color') }}
                                <span class="color-var-badge">--primary-color</span>
                            </label>
                            <div class="input-group">
                                <input type="text" class="form-control color-text" name="site_primary_color"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ __tr('Primary Dark') }}
                                <span class="color-var-badge">--primary-color-dark</span>
                            </label>
                            <div class="input-group">
                                <input type="text" class="form-control color-text" name="site_primary_color_dark"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ __tr('Primary Light') }}
                                <span class="color-var-badge">--primary-color-light</span>
                            </label>
                            <div class="input-group">
                                <input type="text" class="form-control color-text" name="site_primary_color_light"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ __tr('Primary Lighter') }}
                                <span class="color-var-badge">--primary-color-lighter</span>
                            </label>
                            <div class="input-group">
                                <input type="text" class="form-control color-text" name="site_primary_color_lighter"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ __tr('Site Header Color') }}
                                <span class="color-var-badge">--header-color</span>
                            </label>
                            <div class="input-group">
                                <input type="text" class="form-control color-text" name="site_header_color"
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ __tr('Main Color Two') }}
                                <span class="color-var-badge">--main-color-two</span>
                            </label>
                            <div class="input-group">
                                <input type="text" class="form-control color-text" name="site_main_color_two"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ __tr('Main Color Three') }}
                                <span class="color-var-badge">--main-color-three</span>
                            </label>
                            <div class="input-group">
                                <input type="text" class="form-control color-text" name="site_main_color_three"
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ __tr('Heading Color') }}
                                <span class="color-var-badge">--heading-color</span>
                            </label>
                            <div class="input-group">
                                <input type="text" class="form-control color-text" name="site_heading_color"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ __tr('Base / Secondary Color') }}
                                <span class="color-var-badge">--secondary-color</span>
                            </label>
                            <div class="input-group">
                                <input type="text" class="form-control color-text" name="site_base_color"
