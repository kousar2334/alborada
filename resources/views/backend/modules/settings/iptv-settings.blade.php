@php
    $links = [['title' => 'IPTV Settings', 'route' => '', 'active' => true]];
@endphp
...
@section('page-content')
    <x-admin-page-header title="IPTV Settings" :links="$links" />
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card card-outline card-primary">
                            <div class="card-header">
                                <h3 class="card-title">
                                    <i class="fas fa-tv mr-2"></i>{{ __tr('Xtream Codes API') }}
                                </h3>
                                <div class="card-tools">
                                    <div class="custom-control custom-switch">
                                        ...
                                        <label class="custom-control-label" for="iptv_provisioning_enabled">
                                            {{ __tr('Auto-Provision') }}
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="url" name="xtream_base_url" class="form-control"
                                        value="{{ get_setting('xtream_base_url') }}"
                                        placeholder="http://yourserver.com:8080">
                                    <small class="form-text text-muted">{{ __tr('No trailing slash. Example: http://yourserver.com:8080') }}</small>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <input type="password" name="xtream_admin_password" class="form-control"
                                        value="{{ get_setting('xtream_admin_password') }}"
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card card-outline card-success">
                            <div class="card-header">
                                <h3 class="card-title">
                                    <i class="fas fa-server mr-2"></i>{{ __tr('WHMCS Integration') }}
                                </h3>
                                <div class="card-tools">
                                    <div class="custom-control custom-switch">
                                        ...
                                        <label class="custom-control-label" for="whmcs_sync_enabled">
                                            {{ __tr('Sync Enabled') }}
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <input type="password" name="whmcs_api_secret" class="form-control"
                                        value="{{ get_setting('whmcs_api_secret') }}"
                                        placeholder="••••••••" autocomplete="new-password">
                                </div>
                            </div>
                        </div>
