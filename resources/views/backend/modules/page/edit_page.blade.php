                    ...
                    <div class="col-lg-9 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group design-mode-option {{ $page->is_design_mode ? '' : 'd-none' }}">
                                    <label>{{ __tr('Custom CSS') }}</label>
                                    <textarea class="form-control page-custom-css" name="custom_css" rows="8"
                                        placeholder=".my-section { padding: 60px 0; }">{{ $page->custom_css }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div
                                        ...
                                        <input type="checkbox" name="build_with" id="pageDesignModeSwitcher"
                                            class="custom-control-input" @checked($page->is_design_mode)>
