@php
    $links = [
        ['title' => 'Resellers', 'route' => route('admin.resellers.index'), 'active' => false],
        ['title' => $reseller->name . ' - Credit Logs', 'route' => '', 'active' => true],
    ];
@endphp
@extends('backend.layouts.dashboard_layout')
@section('page-title') Credit Logs @endsection
        ...
        <div class="card">
            <div class="card-body p-0">
                <table class="table table-bordered table-hover mb-0">
                    <thead>
                        <tr><th>Date</th><th>Type</th><th>Amount</th><th>Balance After</th><th>Description</th><th>Client</th></tr>
                    </thead>
                    <tbody>
                        @forelse($logs as $log)
                        <tr>
