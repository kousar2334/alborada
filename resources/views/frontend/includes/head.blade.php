<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('web-assets/frontend/css/bootstrap.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('web-assets/frontend/css/plugin.css') }}">
    <link rel="stylesheet" href="{{ asset('web-assets/frontend/css/main-style.css') }}">
    <link rel="stylesheet" href="{{ asset('web-assets/frontend/css/helpers.css') }}">
    <link rel="stylesheet" href="{{ asset('web-assets/common/css/toastr.min.css') }}">
    <link rel="stylesheet" href="{{ asset('web-assets/frontend/css/jquery.ihavecookies.css') }}">
