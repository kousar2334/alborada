        ...
        <div class="card">
            ...
            <div class="card-body" style="padding:24px;">
                <form action="{{ route('reseller.account.update') }}" method="post">
                    ...
                    <div class="form-group mb-20">
                        <label style="font-size:.8rem;color:var(--muted);margin-bottom:6px;display:block;">Company / Business Name</label>
                    ...
                    <div class="form-group mb-20">
                        <label style="font-size:.8rem;color:var(--muted);margin-bottom:6px;display:block;">Email Address</label>
                    ...
                    <button type="submit" class="cmn-btn" style="background:var(--green);color:#000;">
                        Save Changes
                    </button>
                </form>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="padding:24px;">
                <form action="{{ route('reseller.account.password') }}" method="post">
                    ...
                    <div class="form-group mb-20">
                        <label style="font-size:.8rem;color:var(--muted);margin-bottom:6px;display:block;">Current Password</label>
                    ...
                    <div class="form-group mb-20">
                        <label style="font-size:.8rem;color:var(--muted);margin-bottom:6px;display:block;">New Password</label>
                        <input type="password" name="new_password" class="input-style"
                    ...
                    <div class="form-group mb-20">
                        <label style="font-size:.8rem;color:var(--muted);margin-bottom:6px;display:block;">Confirm New Password</label>
