            ...
            <div class="col-lg-10">
                ...
                @else
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <code id="cred-username"
                                            class="flex-grow-1 bg-light p-2 rounded">{{ $credentials['username'] ?? 'N/A' }}</code>
                                        <button class="btn btn-sm btn-outline-secondary ml-2"
                                            onclick="copyText('cred-username')">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <code id="cred-password"
                                            class="flex-grow-1 bg-light p-2 rounded">{{ $credentials['password'] ?? 'N/A' }}</code>
                                        <button class="btn btn-sm btn-outline-secondary ml-2"
                            ...
                            @if (!empty($credentials['m3u_url']))
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <code id="cred-m3u"
                                            class="flex-grow-1 bg-light p-2 rounded code-wrap">{{ $credentials['m3u_url'] }}</code>
                                        <button class="btn btn-sm btn-outline-secondary ml-2"
                                            onclick="copyText('cred-m3u')">
                                            <i class="fas fa-copy"></i>
                                        </button>
                                    </div>
                                </div>
                                <div class="mb-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <code id="cred-epg"
                                            class="flex-grow-1 bg-light p-2 rounded code-wrap">{{ $credentials['epg_url'] }}</code>
                                        <button class="btn btn-sm btn-outline-secondary ml-2"
                                            onclick="copyText('cred-epg')">
                                            <i class="fas fa-copy"></i>
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs" id="appTabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="tab-smarters" data-toggle="tab" href="#smarters"
                                        role="tab">IPTV Smarters</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-tivimate" data-toggle="tab" href="#tivimate"
                                        role="tab">TiviMate</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-xciptv" data-toggle="tab" href="#xciptv"
                                        role="tab">XCIPTV</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-vlc" data-toggle="tab" href="#vlc" role="tab">VLC /
                                        Other</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body tab-content">
                            ...
                            <div class="tab-pane fade show active" id="smarters" role="tabpanel">
                                ...
                                <ol>
                                    <li>Download <strong>IPTV Smarters Pro</strong> from the App Store / Google Play /
                                        Amazon.</li>
                                    <li>Open the app and tap <strong>"Add User"</strong>.</li>
                                    <li>Choose <strong>"Login with Xtream Codes API"</strong>.</li>
                                    <li>Enter the following:
                                        <ul>
                                            <li><strong>Username:</strong> <code>{{ $credentials['username'] ?? '' }}</code>
                                            </li>
                                            <li><strong>Password:</strong>
                                                <code>{{ $credentials['password'] ?? '' }}</code>
                                            </li>
                                            <li><strong>URL:</strong>
                                                <code>{{ rtrim(get_setting('xtream_base_url', ''), '/') }}</code>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <div class="tab-pane fade" id="tivimate" role="tabpanel">
                                ...
                                <p class="text-muted small">TiviMate Companion (premium) is recommended for EPG and
                                    recordings.</p>
                            </div>
                            ...
                            <div class="tab-pane fade" id="vlc" role="tabpanel">
                                ...
                                <ol>
                                    ...
                                    <li>In VLC: <strong>Media → Open Network Stream</strong>, paste the URL and click Play.
                                    </li>
                                    <li>In Kodi: install the <strong>PVR IPTV Simple Client</strong> addon, paste the M3U
                                        URL in settings.</li>
                    ...
                    <div class="mt-4 text-center">
                        <p>Need help? <a href="{{ route('member.tickets.create') }}">Open a support ticket</a> and our team
                            will assist you.</p>
                    </div>
                @endif
            </div>
