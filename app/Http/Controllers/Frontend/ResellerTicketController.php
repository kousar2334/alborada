...
class ResellerTicketController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.pages.reseller.tickets.index', compact('tickets'));
    }

    public function create()
    {
        return view('frontend.pages.reseller.tickets.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('reseller.tickets.show', $ticket->ticket_number)
            ->with('success', __tr('Ticket submitted. We will respond shortly.'));
    }
    ...
    public function show(string $ticketNumber)
    {
        ...
        return view('frontend.pages.reseller.tickets.show', compact('ticket'));
    }
